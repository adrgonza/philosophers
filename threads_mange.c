...
/*   Updated: 2023/04/13 19:21:27 by adrgonza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int ft_check_death(t_data *data, int i)
{
	...
	if (data->act_time - data->philo[i].last_time_eat > data->philo[i].time_to_die)
	{
	...
	if ((data->philo[i].times_eaten == data->philo[i].nb_philos_eat) && data->philo[i].alredy_eaten == 0)
	{
